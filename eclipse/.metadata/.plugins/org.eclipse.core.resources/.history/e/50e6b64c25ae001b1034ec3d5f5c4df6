...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    {
        this.buttonList.add(new GuiButton(0, this.width / 2 + 100, this.height / 2 - 20, 96, 20, "Kernel"));
        this.buttonList.add(new GuiButton(4, this.width / 2 + 100, this.height / 2 + 5, 96, 20, "Session Changer"));
