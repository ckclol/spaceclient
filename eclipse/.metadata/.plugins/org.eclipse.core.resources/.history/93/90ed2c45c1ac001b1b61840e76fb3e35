...
public class GuiWatchdog2 extends GuiScreen {
	private GuiScreen previousScreen;
    private GuiTextField username;

    public GuiWatchdog2(GuiScreen previousScreen) {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(0, this.width / 2 - 50, this.height / 2 - 20,  98, 20, I18n.format("Speeding", new Object[0])));
